# -*- coding: utf-8 -*-
"""Miller Barrera - Week 1 Project - PFDI.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1sUsUrPM7rMt_5SP2-ea7b5uyWYbEqfrt
...
currencyChoise = cc.convert(1,'USD','AUD')

# Multiply the dollar column by your currency of choice
matrix[:, 1] = matrix[:,1]*currencyChoise
print(matrix[:,1])
...
vector=np.vectorize(from_location_to_airbnb_listing_in_meters)
print(vector(latitude,longitude,matrix[:,2], matrix[:,3]))
...
def from_location_to_airbnb_listing_in_meters(lat1: float, lon1: float, lat2: list, lon2: list):   
    R = 6371000  # Radius of Earth in meters
    phi_1 = math.radians(lat1) # CHANGE THIS
    phi_2 = math.radians(lat2) # CHANGE THIS

    delta_phi = math.radians(lat2 - lat1) # CHANGE THIS
    delta_lambda = math.radians(lon2 - lon1) # CHANGE THIS

    a = (
        math.sin(delta_phi / 2.0) ** 2 # CHANGE THIS
        + math.cos(phi_1) * math.cos(phi_2) * math.sin(delta_lambda / 2.0) ** 2 # CHANGE THIS (3x)
    )

    c = 2 * math.atan2(math.sqrt(a), math.sqrt(1 - a)) # CHANGE THIS (3x)

    meters = R * c  # Output distance in meters

    return round(meters, 0) # CHANGE THIS
